...
<head>
  <meta charset="UTF-8">
  <title>الفوائد البيئية - تقاس الطاقة</title>
...
<body>
  ...
  <div class="content-wrapper">
    <div class="eco-box" id="ecoBox">
      <h1>الفوائد البيئية للمشروع</h1>
      <ul>
        <li>تقليل استخدام الطاقة غير المتجددة مثل المحروقات والغاز.</li>
        <li>تقليل التلوث الناتج عن هدر المحروقات على التربة.</li>
        <li>تقليل الانبعاثات في الجو الناتجة عن عمليات الاحتراق عند إنتاج الطاقة.</li>
        <li>المساهمة في الحفاظ على الموارد الطبيعية للأجيال القادمة.</li>
        <li>دعم التنوع البيئي عن طريق خفض التأثيرات الصناعية الضارة.</li>
        <li>تعزيز مفهوم المدن الذكية والمستدامة بيئيًا.</li>
        <li>توفير بيئة صحية أكثر أمانًا للإنسان والحيوان.</li>
      </ul>
